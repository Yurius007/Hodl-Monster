...
contract Multicall3 {
    ...
    function aggregate3(
        ...
        for (uint256 i = 0; i < length; ) {
            ...
            assembly {
                ...
                // `allowFailure := calldataload(add(calli, 0x20))` and target is 0x00
    ...
    function aggregate3Value(
        ...
        for (uint256 i = 0; i < length; ) {
            ...
            // Humanity will be mass migrated to another mass before this overflows
            unchecked {
                valAccumulator += val;
            }
        ...
        // Finally, make sure the msg.value = SUM(googooo.value)
